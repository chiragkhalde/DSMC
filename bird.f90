!----------------------------------------------------------------
!  DSMC SIMULATION OF RAREFIED FLOW FROM AN ORIFICE TO A VACUUM 
...
!----------------------------------------------------------------
        ...
        real(kind=8), parameter :: rho_inject = 1.0d-7  
        real(kind=8), parameter :: v_inject = 2000.0d0  
        real(kind=8), parameter :: T_inject = 1000.0d0  
...
! apply BC
        ...
        if(mod(n,10).eq.0) then
         print*, 'numpar, nrecycle: ', numpar, nrecycle
